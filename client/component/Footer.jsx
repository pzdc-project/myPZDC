      ...
      <div className="footer">
        <div className="footer__block">
          ...
          <span className="footer__legal">
            <div>Copyright &copy; 2018 <a href="https://pzdc.org/">PZDC Project</a></div>
          </span>
        </div>
        <div className="footer__block">
        ...
        <div className="footer__block">
          <div className="footer__social-media-wrapper">
            ...
            <div>
              <a href="https://bitcointalk.org/index.php?topic=4722783.0" target="_blank">
                <Icon name="bitcoin" className="fab footer__social-media-icon" />
              </a>
              <a href="https://discord.gg/2GF6Cdn" target="_blank">
                <Icon name="discord" className="fab footer__social-media-icon" />
              </a>
              <a href="https://t.me/joinchat/I0goTE1VNJK4WNkK4wLqWw" target="_blank">
                <Icon name="telegram" className="fab footer__social-media-icon" />
              </a>
              <a href="https://www.reddit.com/r/PZDCProject/" target="_blank">
                <Icon name="reddit" className="fab footer__social-media-icon" />
              </a>
              <a href="https://github.com/pzdc-project/pzdc/" target="_blank">
                <Icon name="github" className="fab footer__social-media-icon" />
              </a>
              <a href="https://twitter.com/PZDCProject" target="_blank">
                <Icon name="twitter" className="fab footer__social-media-icon" />
              </a>
              <a href="https://facebook.com/pzcdproject" target="_blank">
