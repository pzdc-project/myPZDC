...
.container .button {
  ...
  <body>
    <div class="logo">
      <a href="https://pzdc.org/">
        <img src="https://pzdc.org/uploads/2018/07/pzdc-sitelogo.png" title="PZDC - Project Zenith"/>
      </a>
      </div>
    <div class="container">
        <img src="https://media.giphy.com/media/vIDsZm5DMZ5Ha/giphy.gif" title="Sad Explorer."/>
      <h1>Maintenance</h1>
      <p>PZDC Explorer is not available currently.<br/>Please check back in a little while.</p><br/>
  <a href="https://pzdc.org/" class="button">Back to Main</a>
      </div>
  </body>
</html>
  `);
